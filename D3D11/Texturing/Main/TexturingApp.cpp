...
namespace Framework
{
    void TexturingApp::updateScene(const float dt)
    {
    ...
    void TexturingApp::onMouseMove(WPARAM btnState,  const int32_t x, const int32_t y)
    {
    ...
    void TexturingApp::buildGeometryBuffers()
    {
        // 
    ...
    void TexturingApp::buildShaders()
    {
        //
