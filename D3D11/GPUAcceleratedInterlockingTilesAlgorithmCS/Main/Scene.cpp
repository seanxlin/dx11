...
namespace TerrainSceneUtils
{
    ...
    void draw(TerrainScene& terrainScene)
    {
        ...
        { 
            terrainScene.mGridHSPerFrameBuffer.mBuffer 
        };
        context.HSSetConstantBuffers(0, 1, &hullShaderBuffers);

        // Resources
        ID3D11ShaderResourceView * const hullShaderResources[] = 
        { 
            Globals::gShaderResources.mGroupResultsSRV 
        };
        context.HSSetShaderResources(0, 1, hullShaderResources);
        ...
        {
            terrainScene.mGridDSPerFrameBuffer.mBuffer 
        };
        context.DSSetConstantBuffers(0, 1, &domainShaderBuffers);

        // Resources
        ID3D11ShaderResourceView * const domainShaderResources[] = 
        { 
            Globals::gShaderResources.mHeightMapSRV 
        };
