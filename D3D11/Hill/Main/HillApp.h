...
namespace Framework
{
    ...
    public:
        ...
        void onMouseDown(WPARAM btnState, const int32_t x, const int32_t y)
        {
            mLastMousePos.x = x;
            mLastMousePos.y = y;
        ...
        void onMouseUp(WPARAM btnState, const int32_t x, const int32_t y)
        {
            ReleaseCapture();
        }
    ...
    private:
        ...
        void buildVertexLayout(std::vector<char>& compiledShader)
        {
