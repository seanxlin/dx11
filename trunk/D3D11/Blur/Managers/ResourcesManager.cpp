...
namespace Managers
{
    ...
    ID3D11ShaderResourceView* ResourcesManager::mOffscreenSRV = nullptr;
    ID3D11UnorderedAccessView* ResourcesManager::mOffscreenUAV = nullptr;
    ID3D11RenderTargetView* ResourcesManager::mOffscreenRTV = nullptr;
