...
{    
    ...
    {
        assert(shaderResources.mDiffuseMapSRV);
        assert(shaderResources.mCSResultsSRV);
        assert(shaderResources.mCSResultsUAV);

        shaderResources.mDiffuseMapSRV->Release();
        shaderResources.mCSResultsSRV->Release();
        shaderResources.mCSResultsUAV->Release();
    }
}
