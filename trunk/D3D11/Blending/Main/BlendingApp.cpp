...
namespace Framework
{
    ...
    void BlendingApp::drawScene()
    {
        ...
        ID3D11Buffer* vertexShaderConstantBuffers[] = { mPerFrameBuffer.mBuffer, mPerObjectBuffer.mBuffer };
        ID3D11Buffer* pixelShaderConstantBuffers[] = { mPerFrameBuffer.mBuffer, mPerObjectBuffer.mBuffer, mImmutableBuffer.mBuffer };
